...
TODO: 
	Style the site
	Add racer slideshow to play before the race
	Add racers to loser bracket
	Randomize the initial bracket	
	Display the average race time, or average racers per (some unit of time)
*/
