	...
	*/
	...
	$.GridRotator.prototype	= {
		...
		_init				: function( options ) {
			...
			//this.animTypesAll	= ['slideLeft', 'slideRight', 'slideTop', 'slideBottom', 'rotateLeft', 'rotateRight', 'rotateTop', 'rotateBottom', 'scale', 'rotate3d', 'rotateLeftScale', 'rotateRightScale', 'rotateTopScale', 'rotateBottomScale' ];
			
			//custom 
			this.animTypesAll	= ['slideLeft', 'slideRight', 'slideTop', 'slideBottom'];
